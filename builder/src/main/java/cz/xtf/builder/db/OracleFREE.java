...
/**
 * Note that to be able to use the oracle FREE on Openshift you need to run as user with 54321 user id.
 ...
 *
 * Also, the OracleFREE image doesn't provide any option to add custom database and user on setup.
 */
public class OracleFREE extends AbstractSQLDatabase {
    ...
    private static final String DATA_DIR = "/opt/oracle/oradata";
    ...
    public OracleFREE(String username, String password, String dbName) {
    ...
    public Map<String, String> getImageVariables() {
        //OracleFREE database image doesn't create custom database and user on setup, thus we don't need the default ImageVariable

...
public class DeploymentConfigBuilder extends AbstractBuilder<DeploymentConfig, DeploymentConfigBuilder> {
	...
	public DeploymentConfigBuilder(String name, String podName) {
		this(null, name, podName);
	}

	DeploymentConfigBuilder(ApplicationBuilder applicationBuilder, String name, String podName) {
		super(applicationBuilder, name);
		podBuilder = new PodBuilder(this, podName);
	}
